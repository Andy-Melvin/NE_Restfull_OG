...
const AttendantLayout: React.FC<AttendantLayoutProps> = ({ children, title }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/attendant/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { name: 'Car Entry', href: '/attendant/car-entry', icon: <Car className="w-5 h-5" /> },
    { name: 'Car Exit', href: '/attendant/car-exit', icon: <ParkingCircle className="w-5 h-5" /> },
    { name: 'Space Management', href: '/attendant/space-management', icon: <Table className="w-5 h-5" /> },
  ];
